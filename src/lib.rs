// src/lib.rs
/*
 * Core library for FlywayMigrate
 */
...
#[derive(Debug)]
pub struct FlywayMigrateProcessor {
    verbose: bool,
    processed_count: usize,
}

impl FlywayMigrateProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting FlywayMigrate processing");
    
    let mut processor = FlywayMigrateProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = FlywayMigrateProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = FlywayMigrateProcessor::new(false);
